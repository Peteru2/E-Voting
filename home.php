...
<div class="containe-fluid">
	...
	// $qry = mysqli_query($conn,"SELECT * FROM votes where user_id = '".$idf."' ");
	?>
	<div class="row col-md-12">
		<div class="col-lg-12 mt-2">

			<div class="card col-md-4 col-sm-8 offset-2 bg-info float-left">
			...
			<div class="card col-md-4 col-sm-6 offset-2 bg-primary ml-4 float-left">
				<div class="card-body text-white">
					<h4><b>Voted</b></h4>
					<hr>
					...
					<!-- <h3 class="text-right"><b><?php echo $idf. "the lord is good"; ?></b></h3> -->
	...
	<div class = "col-md-12 row mt-3 text-white">
	...
	<A class = "offset-6 btn-danger rounded p-2 text-white" href = "index.php?page=vote_sheet" >Vote</a>
	 <?php endif; ?> 

	 <?php if (mysqli_num_rows($del_query) > 0):?> 
	<A class = "offset-6 btn-success rounded p-2 text-white" href = "voting.php?page=view_vote" > View My Vote</a>
	 <?php endif; ?> 
	</div>
